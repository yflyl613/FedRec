...
class LIE():
    ...
    def prepare(self, server_model, *args):
        ...
        with torch.no_grad():
            ...
            self.client_other_grad = other_grad_mean - self.z_max * other_grad_std
            ...
            self.client_item_grad = item_grad_mean - self.z_max * item_grad_std
    ...
    def update(self, server_model, client_id):
        ...
        return client_user_grad, self.client_item_grad, self.client_other_grad, client_sample_num
